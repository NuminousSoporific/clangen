...
class Pelt():
    ...
    def __init__(self,
        ...
        self.cat_sprites['newborn'] = 26
        self.cat_sprites['para_young'] = 22
    ...
    def check_and_convert(self, convert_dict):
        ...
        if self.length == 'long':
            ...
            self.cat_sprites['para_adult'] = 20
        if self.cat_sprites['senior'] not in [16, 17, 18]:
    ...
    def pattern_color_inheritance(self, parents: tuple=(), gender="female"):
        ...
        if game.settings["male_tortie_chance"]:
            tortie_chance_m = game.config["cat_generation"]["base_female_tortie"]
        else:
    ...
    def randomize_pattern_color(self, gender):
        ...
        if game.settings["male_tortie_chance"]:
            tortie_chance_m = game.config["cat_generation"]["base_female_tortie"] - 1
        else:
            tortie_chance_m = game.config["cat_generation"]["base_male_tortie"]
        if gender == "female":
            torbie = random.getrandbits(tortie_chance_f) == 1
    ...
    def init_sprite(self):
        self.cat_sprites = {
            'newborn': 26,
            'kitten': random.randint(0, 3),
            'adolescent': random.randint(4, 7),
            'senior': random.randint(16, 19),
            'sick_young': 25,
            'sick_adult': 24
        }
        ...
        if self.length != 'long':
            self.cat_sprites['adult'] = random.randint(8, 11)
            self.cat_sprites['para_adult'] = 20
        else:
            self.cat_sprites['adult'] = random.randint(12, 15)
            self.cat_sprites['para_adult'] = 21
        self.cat_sprites['young adult'] = self.cat_sprites['adult']
        self.cat_sprites['senior adult'] = self.cat_sprites['adult']
